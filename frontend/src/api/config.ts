...
/** 业务 API 路径前缀（与后端 ``main.py`` 中 ``prefix="/api"`` 对齐）。 */
export const API_PATH_PREFIX = resolveApiPathPrefix()

function resolveApiPathPrefix(): string {
  const v = import.meta.env.VITE_API_PATH_PREFIX
